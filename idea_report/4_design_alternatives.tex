...
It is also responsible to authenticate a new user using TUM Web Services to prevent identity theft.

We intent to use Node.js as a back-end. Referring to projects it is already used for, it provides a reliable and fast service.

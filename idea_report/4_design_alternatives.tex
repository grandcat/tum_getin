...
The first proposed protocol
% TODO: add details about used terminology

Contains ideas of the Needham-Schroeder-Lowe Public Key protocol, but the fixed version by Lowe.
